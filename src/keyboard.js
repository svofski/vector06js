...
function Keyboard() {
    ...
    var keymap = {
    	...
    	71: [4, 0x80], 	70: [4, 0x40],	69: [4, 0x20],  68: [4, 0x10],	67: [4, 0x08],	66: [4, 0x04],	65: [4, 0x02], 189: [4, 0x01], // 189:-@
    	...
    	116:[1, 0x80], 115: [1, 0x40], 114: [1, 0x20], 113: [1, 0x10], 112: [1, 0x08],	27: [1, 0x04], 119 /*F8*/: [1, 0x02], 118 /*F7*/: [1, 0x01],
