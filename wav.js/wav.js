...
/*
 * do we need direct access to  samples? -- ffdead
 */
/* why is this even a question? -- svofski */
wav.prototype.getSamples = function (buffer) {

  // TODO load data chunk into buffer
  if (this.bitsPerSample === 8)
    this.dataSamples = new Uint8Array(buffer, 44);//, this.chunkSize/this.blockAlign);
  else if (this.bitsPerSample === 16)
    this.dataSamples = new Int16Array(buffer, 44);//, this.chunkSize/this.blockAlign);
}
